...
public class AutonomousModes {
	...
	public static final AutonomousMode[] AUTONOMOUS_MODES = new AutonomousMode[] {
		...
		// new AutonomousMode("ScoreHighCube", () -> new ScoreHigh(GamePieceType.CUBE)),
		// new AutonomousMode("OnePieceExitCommunity", () -> new OnePieceExitCommunity(GamePieceType.CUBE)),
		// new AutonomousMode("OnePieceExitCommunityBalance", () -> new OnePieceExitCommunityBalance(GamePieceType.CONE)),
